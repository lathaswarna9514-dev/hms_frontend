/**
 * Doctor Portal Navigation Generator
 */
                ...
                <table class="menu-container" border="0">
                    <tr>
                        <td style="padding:30px;text-align:center">
                            <p style="margin:0;padding:0"><span class="edoc-logo">eDoc.</span><span class="edoc-logo-sub">| Doctor</span></p>
                        </td>
                    </tr>
                    <tr class="menu-row">
                    ...
                    <tr class="menu-row">
                        <td class="menu-btn ${activeTab === 'sessions' ? 'menu-active' : ''}">
                            <a href="sessions.html" class="non-style-link-menu">
                                <div><img src="../img/icons/session.svg" class="menu-icon">&nbsp;&nbsp;My Sessions</div>
                            </a>
                        </td>
                    </tr>
                    <tr class="menu-row">
                        <td class="menu-btn ${activeTab === 'appointments' ? 'menu-active' : ''}">
                            <a href="appointments.html" class="non-style-link-menu">
                                <div><img src="../img/icons/book.svg" class="menu-icon">&nbsp;&nbsp;My Appointments</div>
                            </a>
                        </td>
                    </tr>
                    <tr class="menu-row">
                        <td class="menu-btn ${activeTab === 'patients' ? 'menu-active' : ''}">
                            <a href="patients.html" class="non-style-link-menu">
                                <div><img src="../img/icons/patients.svg" class="menu-icon">&nbsp;&nbsp;My Patients</div>
                            </a>
                        </td>
                    </tr>
                    <tr class="menu-row">
                        <td class="menu-btn ${activeTab === 'leaves' ? 'menu-active' : ''}">
                            <a href="leaves.html" class="non-style-link-menu">
                                <div><img src="../img/icons/schedule.svg" class="menu-icon">&nbsp;&nbsp;My Leaves</div>
                            </a>
                        </td>
                    </tr>
                    <tr class="menu-row">
                        <td class="menu-btn ${activeTab === 'prescription' ? 'menu-active' : ''}">
                            <a href="prescription.html" class="non-style-link-menu">
                                <div><img src="../img/icons/book.svg" class="menu-icon">&nbsp;&nbsp;Prescriptions</div>
                            </a>
                        </td>
                    </tr>
                    <tr class="menu-row">
